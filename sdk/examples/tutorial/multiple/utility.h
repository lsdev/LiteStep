...
/**
 * Just like GetRCBoolDef, but the key can be split into a prefix and a suffix.
 */
BOOL GetRCBoolDef(LPCTSTR pszKeyPrefix, LPCTSTR pszKeySuffix, BOOL fDefault);

/**
 * Just like GetRCColor, but the key can be split into a prefix and a suffix.
 */
...
/**
 * Just like GetRCInt, but the key can be split into a prefix and a suffix.
 */
int GetRCInt(LPCTSTR pszKeyPrefix, LPCTSTR pszKeySuffix, int nDefault);

/**
 * Just like GetRCString, but the key can be split into a prefix and a suffix.
 */
