...
BOOL GetRCBoolDef(LPCTSTR pszKeyPrefix, LPCTSTR pszKeySuffix, BOOL fDefault)
{
    TCHAR szKey[MAX_KEY];
    
    // Form the full key name
    StrCopy(szKey, MAX_KEY, pszKeyPrefix);
    StrCat(szKey, MAX_KEY, pszKeySuffix);
    
    return GetRCBoolDef(szKey, fDefault);
}


COLORREF GetRCColor(LPCTSTR pszKeyPrefix, LPCTSTR pszKeySuffix, COLORREF crDefault)
{
    TCHAR szKey[MAX_KEY];
    ...
    return GetRCColor(szKey, crDefault);
}


int GetRCEnum(LPCTSTR pszKeyPrefix, LPCTSTR pszKeySuffix, LPENUM pEnum)
{
    TCHAR szName[MAX_ENUM_NAME];
    
    // Get the name from the configuration file
    GetRCString(pszKeyPrefix, pszKeySuffix, szName, NULL, MAX_ENUM_NAME);
...
int GetRCInt(LPCTSTR pszKeyPrefix, LPCTSTR pszKeySuffix, int nDefault)
{
    TCHAR szKey[MAX_KEY];
    ...
    return GetRCInt(szKey, nDefault);
}


BOOL GetRCString(LPCTSTR pszKeyPrefix, LPCTSTR pszKeySuffix, LPTSTR pszBuffer, LPCTSTR pszDefault, int cchBuffer)
{
    TCHAR szKey[MAX_KEY];
    ...
    return GetRCString(szKey, pszBuffer, pszDefault, cchBuffer);
}
