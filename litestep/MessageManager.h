...
private:
	typedef set
		<HWND> windowSetT;
	typedef map<UINT, windowSetT> messageMapT;
...
public:
	...
	void GetWindowsForMessage(UINT message, vector<HWND> &rvHwnd);
	void GetMessagesForWindow(HWND hwnd, vector<HWND> &rvMessage);
};
