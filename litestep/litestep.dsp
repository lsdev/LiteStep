...
# ADD LINK32 ..\lsapi\release\lsapi.lib ../hook/release/hook.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib kernel32.lib user32.lib delayimp.lib shlwapi.lib /nologo /subsystem:windows /pdb:none /map /machine:I386 /nodefaultlib:"libcmt.lib" /opt:NOWIN98 /delayload:"hook.dll" /MAPINFO:LINES /MAPINFO:EXPORTS
...
# ADD CPP /nologo /MTd /W3 /WX /GX /ZI /Od /I "../lsapi" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "LSAPI_PRIVATE" /FAs /FR /FD /c
