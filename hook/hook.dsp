...
# ADD LINK32 advapi32.lib kernel32.lib user32.lib /nologo /subsystem:windows /dll /pdb:none /map:"../Release_VC6/hook.map" /machine:I386 /nodefaultlib /def:".\Hook.def" /opt:NOWIN98 /MAPINFO:LINES /MAPINFO:EXPORTS
...
# ADD LINK32 advapi32.lib kernel32.lib user32.lib msvcrtd.lib oldnames.lib /nologo /subsystem:windows /dll /map:"../Debug_VC6/hook.map" /debug /machine:I386 /nodefaultlib /MAPINFO:LINES /MAPINFO:EXPORTS
