...
# ADD LINK32 Advapi32.lib kernel32.lib user32.lib /nologo /subsystem:windows /dll /pdb:none /machine:I386 /def:".\Hook.def" /out:"../litestep/Release/hook.dll" /opt:NOWIN98
