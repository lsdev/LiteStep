...
/*
 EPSRevision History
   ...
   J. Kercheval  Sun, 03/10/1991  20:37:11  beef up _tmain()
...
BOOL is_valid_pattern (_TCHAR *p, int *error_type)
{
	/* init error_type */
...
int matche_after_star (_TCHAR *p, _TCHAR *t)
{
	int match = 0;
	_TCHAR nextp;
